...
<div x-data="{
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Kelola dokumen peraturan yang tampil di website Anda
                </p>
            </div>
        ...
        <div class="space-y-5">
            ...
            <div class="bg-white border border-gray-200 rounded-xl
                ...
                <div class="sm:w-40 w-full flex items-center justify-center">
                    <div class="w-24 h-24 bg-blue-50 rounded-xl flex items-center justify-center text-4xl">
                        📄
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col justify-between">
                    ...
                    <div class="flex flex-wrap gap-3 justify-end mt-4">
                        ...
                        <a href="{{ asset('storage/peraturans/'.$data->file) }}"
                            target="_blank"
                        ...
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                            action="{{ route('peraturan.destroy', $data->id) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
            ...
            <div class="border border-gray-200 p-6 rounded-xl text-center">
                <p class="text-base text-gray-500">
                    Belum ada data Peraturan tersedia.
                </p>
            </div>
            @endforelse
    ...
    <div x-show="open"
        ...
        <div @click.outside="reset()"
            ...
            <form action="{{ route('peraturan.store') }}"
                method="POST"
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        placeholder="Contoh: Peraturan Disiplin Pegawai"
                        required>
                </div>
