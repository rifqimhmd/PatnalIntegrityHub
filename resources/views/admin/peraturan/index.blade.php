    ...
    <div x-show="open"
        ...
        <div @click.outside="open=false"
            ...
            <div class="flex justify-between items-center mb-5">
                <h2 class="text-lg font-bold">Tambah Peraturan</h2>
            ...
            <form action="{{ route('peraturan.store') }}"
                ...
                {{-- Judul --}}
                <div>
                    <label class="text-sm font-semibold text-gray-700">Judul Peraturan</label>
                    <input type="text"
                           name="judul"
                           required
                ...
                {{-- File PDF --}}
                <div>
                    <label class="text-sm font-semibold text-gray-700">File Peraturan (PDF)</label>
                    <input type="file"
                           name="file"
